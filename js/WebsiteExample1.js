...
class WebsiteExample1 extends Component {
  constructor() {
    super();
  ...
  render() {
    return (
      <Motion defaultStyle={{width: 600}} style={{width: spring(this.state.width, [60, 15])}}>
        {values => (
...
reactMixin(WebsiteExample1.prototype, createContainerQueryMixin({
  min_with_200: {
    minWidth: 200
  }
}));
